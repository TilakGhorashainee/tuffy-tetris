...
BG = pygame.image.load("pygame-tuffy tetris-Group5/assets/Background.png")
...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("pygame-tuffy tetris-Group5/assets/Play Rect.png"), pos=(300, 250),
                             text_input="PLAY", font=get_font(38), base_color="#d7fcd4", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("pygame-tuffy tetris-Group5/assets/Options Rect.png"), pos=(300, 400),
                                text_input="OPTIONS", font=get_font(38), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("pygame-tuffy tetris-Group5/assets/Quit Rect.png"), pos=(300, 550),
