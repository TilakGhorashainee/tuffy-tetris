...
class Board:
    ...
    def survivaLeaderboard(self, username):
        leaderboard = []
        if not exists("survivaLeaderboard.txt"):
            with open("survivaLeaderboard.txt", "w") as f:
                print("Creating survivaLeaderboard.txt file\n")
        with open("survivaLeaderboard.txt", 'r') as f:
            lines = f.readlines()
            for line in lines:
        ...
        fi = open("survivaLeaderboard.txt", "w")
    ...
    def sprintLeaderboard(self, username):
        leaderboard = []
        if not exists("sprintLeaderboard.txt"):
            with open("sprintLeaderboard.txt", "w") as f:
                print("Creating sprintLeaderboard.txt file\n")
        with open("sprintLeaderboard.txt", 'r') as f:
            lines = f.readlines()
            for line in lines:
                currentLine = line.split(",")
                leaderboard.append([currentLine[0], int(currentLine[1])])
        ...
        fi = open("sprintLeaderboard.txt", "w")
        for score in leaderboard:
            fi.write(score[0])
            fi.write(', ')
            fi.write(str(score[1]))
